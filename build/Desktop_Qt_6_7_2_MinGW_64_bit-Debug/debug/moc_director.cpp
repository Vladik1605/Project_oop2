...
struct qt_meta_stringdata_CLASSDirectorENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDirectorENDCLASS = QtMocHelpers::stringData(
    "Director"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDirectorENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Director::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDirectorENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDirectorENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDirectorENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Director::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDirectorENDCLASS.stringdata0))
